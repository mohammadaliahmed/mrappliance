...
import com.appsinventiv.mrappliance.Activities.ViewPictures;
...
import com.appsinventiv.mrappliance.Utils.DownloadFile;
...
//                DownloadFile.fromUrl1(model.getDocumentUrl());
                ...
                if (applictionFile != null && applictionFile.exists()) {
                    ...
                    DownloadFile.fromUrl1(model.getDocumentUrl(), filename + model.getMediaType(), new DownloadFile.FileDownloaded() {
                        @Override
...
//                    context.startActivity(intent);
    ...
    public int getItemViewType(int position) {
        ...
        if (model.getUsername().equals(SharedPrefs.getUser().getUsername())) {
            return RIGHT_CHAT;
        } else {
            return LEFT_CHAT;
        }
