...
import com.appsinventiv.mrappliance.ApplicationClass;
import com.appsinventiv.mrappliance.Bills.ListOfBills;
import com.appsinventiv.mrappliance.Models.OrderModel;
import com.appsinventiv.mrappliance.Models.PdfModel;
import com.appsinventiv.mrappliance.Models.ServicemanModel;
import com.appsinventiv.mrappliance.Notifications.NotificationHistory;
...
import com.appsinventiv.mrappliance.Services.ListOfServices;
import com.appsinventiv.mrappliance.UserManagement.EditProfile;
...
public class MainActivity extends AppCompatActivity
    ...
    RelativeLayout newBooking, bookingHistory, trackOrder;
    TextView username;
        ...
        if (SharedPrefs.getUser() != null) {
            ...
            FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener(new OnSuccessListener<InstanceIdResult>() {
                ...
                public void onSuccess(InstanceIdResult instanceIdResult) {
                    mDatabase.child("Users").child(SharedPrefs.getUser().getUsername()).child("fcmKey").setValue(instanceIdResult.getToken());
                }
            });
        } else {
            username.setText("Mr Appliance");
...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            ...
            startActivity(new Intent(MainActivity.this, LiveChat.class));
