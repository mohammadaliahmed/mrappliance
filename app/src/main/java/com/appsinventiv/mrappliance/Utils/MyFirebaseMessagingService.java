package com.appsinventiv.mrappliance.Utils;
...
import com.appsinventiv.mrappliance.Activities.ModifiedOrder;
import com.appsinventiv.mrappliance.Activities.MyOrders;
import com.appsinventiv.mrappliance.Activities.ViewQuotation;
...
//                handleNow(msg);
    ...
    private void handleNow(String notificationTitle, String messageBody, String type) {
        ...
        if (type.equalsIgnoreCase("Modify")) {
            ...
            resultIntent = new Intent(this, ViewQuotation.class);
            resultIntent.putExtra("orderId", Id);
